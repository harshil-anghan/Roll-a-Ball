...
public class TurretShoot : MonoBehaviour {
	...
	void shoot()
	{
		GameObject bullet = Instantiate(FireBall,GameObject.Find("TurretShootingSpawn").transform.position,Quaternion.identity)as GameObject;
		bullet.GetComponent<Rigidbody>().AddForce(GameObject.Find("TurretShootingSpawn").transform.forward * fireball_speed);
	}
